# sinrules.md — stealth-captcha: Regeln & Verbote
...
Dieses Repo (stealth-captcha) ist Teil der **SIN-CLIs Stealth Suite** und MUSS:
...
Check mit: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-captcha`
